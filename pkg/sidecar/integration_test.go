...
func TestIntegrationRetryBehavior(t *testing.T) {
	...
	resp, err := client.Chat(context.Background(), "test-portal", "", "", "test message", "", nil, nil, false, 0)
	if err != nil {
...
func TestIntegrationCircuitBreaker(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		_, _ = client.Chat(context.Background(), "test", "", "", "message", "", nil, nil, false, 0)
	}

	// After many failures, circuit should be open
	_, err := client.Chat(context.Background(), "test", "", "", "message", "", nil, nil, false, 0)
...
func TestIntegrationContextCancellation(t *testing.T) {
	...
	_, err := client.Chat(ctx, "test", "", "", "message", "", nil, nil, false, 0)
	if err == nil {
